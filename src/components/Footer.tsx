          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-2.5">
              <a
                ...
                className="flex items-center gap-1.5 bg-[#2D2D2D] border border-gray-600 text-white text-xs font-semibold px-3 py-2 rounded-full hover:bg-[#444444] transition-colors"
                aria-label="Call +91 62904 15915"
              >
              ...
              <a
                ...
                className="flex items-center gap-1.5 bg-[#25D366] text-white text-xs font-semibold px-3 py-2 rounded-full hover:bg-[#1ebe5c] transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>19 Vivekananda Park, Amrabati, Naskarhat,<br />Tiljala, Kolkata 700039</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+916290415915" className="hover:text-white transition-colors">+91 62904 15915</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-[#8C8C8C] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
