      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-[#25D366] text-white font-semibold px-6 py-3.5 rounded-full hover:bg-[#1ebe5c] transition-colors text-sm shadow-lg shadow-[#25D366]/20"
          >
          ...
          <a
            href={`tel:${PHONE}`}
            className="flex items-center gap-2.5 bg-white text-[#2D2D2D] font-bold px-6 py-3.5 rounded-full hover:bg-[#F0F0F0] transition-colors text-sm border-2 border-white shadow-lg"
          >
            <svg className="w-4 h-4 text-[#2D2D2D]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="mt-5 text-xs text-gray-400">
          📞 Free site visit &amp; consultation &nbsp;·&nbsp; Mon–Sat 10 AM – 8 PM &nbsp;·&nbsp; Response within 1 hour
        </p>
      </div>
    </section>
  );
